  ...
  useEffect(() => {
    async function fetchCliente() {
      const data = await axios
        .get(
          "http://residencia-ecommerce.us-east-1.elasticbeanstalk.com/swagger-ui.html#/cliente-controller/listarUsingGET_1"
        )
        .then((res) => res.data);
        ...
        <Row>
          <Col md="1">
            ...
            <Nav.Link defaultActiveKey="/home" className="flex-column">
              <Nav.Link
                onClick={() =>
                  setCrudCliente(<FormCliente novo={novo} setNovo={setNovo} />)
                }
              >
                Adicionar
              </Nav.Link>
